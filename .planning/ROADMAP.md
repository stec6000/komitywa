...
- [x] 03-03-PLAN.md — Recipe detail page with Schema.org JSON-LD and navbar link wiring
...
- [x] 04-03-PLAN.md — Cart page + checkout form + confirmation page + navbar wiring
